...
function createPeople() {
    return [
        ...
        { name: 'Justin Bieber', pic: './img/bieber.png', ladder_guess: 4, ladder_actual: 4, income: 'Infamous but really just misunderstood', fertility: 5, book: 'The Boxcar Children by Gertrude Chandler Warner', bio: 'I’m really pretty. And really a douchebag.', bio_picks: [], pic_picks: [] },
        { name: 'Britney Spears', pic: './img/britney.png', ladder_guess: 5, ladder_actual: 5, income: 'All press is good press', fertility: 5, book: 'The Boxcar Children by Gertrude Chandler Warner', bio: 'I’m not that innocent.', bio_picks: [], pic_picks: [] },
        ...
        { name: 'Donald Trump', pic: './img/trump.png', ladder_guess: 0, ladder_actual: 0, income: 'Infamous but really just misunderstood', fertility: 3, book: 'The Boxcar Children By Gertrude Chandler Warner', bio: 'I have tiny hands. My daughter and I come as a package deal.', bio_picks: [], pic_picks: [] },
